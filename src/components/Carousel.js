...
function Carousel({ data }) {
  ...
  return (
    <div className='logement__carrousel'>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className='chevron chevron_left' onClick={prevSlide}>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className='chevron chevron_right' onClick={nextSlide}>
